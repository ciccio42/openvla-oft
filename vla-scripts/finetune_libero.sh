...
torchrun \
    ...
    --data_root_dir /home/rsofnc000/Multi-Task-LFD-Framework/repo/open_x_embodiment/datasets/libero \
    ...
    --wandb_project "Open_VLA_OFT_LIBERO_finetune_abs_pose_gripper_img" \
