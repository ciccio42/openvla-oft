...
Usage:
    python experiments/robot/libero_plus/regenerate_libero_plus_dataset.py \
...
def main(args):
    ...
    metainfo_json_dict = {}
    metainfo_json_out_path = f"./experiments/robot/libero_plus/{args.libero_task_suite}_metainfo.json"
